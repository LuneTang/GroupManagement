...
import com.vti.dto.ChangePasswordDTO;
...
public class UserController {
	...
	public ResponseEntity<?> changePassword(@RequestBody ChangePasswordDTO dto) {
	    try {
	        userService.changePassword(dto.getEmail(), dto.getOldPassword(), dto.getNewPassword());
	        return new ResponseEntity<>("Change Password Successfully!", HttpStatus.OK);
	    } catch (RuntimeException e) {
	        return new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_REQUEST);  // Return error if exception occurs
	    }
	}
