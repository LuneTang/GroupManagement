...
const RegisterPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const successMsg = "Registration successful! Check your email.";
      ...
      // Nếu lỗi là "Account has been registered", hiển thị form resend
      if (errorMsg.includes("Account has been registered")) {
        setRegisteredEmail(data.email);
        // Đặt successMessage để hiển thị form ResendConfirmationForm
        setSuccessMessage("Account already registered");
      }
    } finally {
      setIsLoading(false);
    }
